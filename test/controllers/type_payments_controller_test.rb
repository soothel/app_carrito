...
class TypePaymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_payment" do
    assert_difference("TypePayment.count") do
      post type_payments_url, params: { type_payment: { deleted: @type_payment.deleted, name: @type_payment.name } }
    end
  ...
  test "should update type_payment" do
    patch type_payment_url(@type_payment), params: { type_payment: { deleted: @type_payment.deleted, name: @type_payment.name } }
