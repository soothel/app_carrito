...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference("Slider.count") do
      post sliders_url, params: { slider: { deleted: @slider.deleted, image: @slider.image, image_mobile: @slider.image_mobile, name: @slider.name, remark: @slider.remark } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { deleted: @slider.deleted, image: @slider.image, image_mobile: @slider.image_mobile, name: @slider.name, remark: @slider.remark } }
