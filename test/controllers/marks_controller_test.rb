...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { deleted: @mark.deleted, image: @mark.image, name: @mark.name } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { deleted: @mark.deleted, image: @mark.image, name: @mark.name } }
